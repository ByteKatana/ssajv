  ...
  return (
    <>
      <tr
        ...
        <td>
          <Moment format="DD/MM/YYYY">{props.start_exec_time}</Moment>
        </td>
        <td>
          <Moment parse="YYYY-MM-DDTHH:mm:ss" format="HH:mm:ss">
            {props.history.run_timestamp}
          </Moment>
        </td>
