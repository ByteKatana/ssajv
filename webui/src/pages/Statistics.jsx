      ...
      job.activity
        ...
        .map((act) => {
          if (act.start_execution_date) {
            ...
            job.history
              .filter(
                (ht) => ht.step_id == "0" && ht.run_date.toString() === activityDate
              )
              .map((ht) => {
              ...
              <Row>
                <Col sm={3}>
                  <Nav variant="pills" className="flex-column">
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="duration-chart">
                        Top 10 Job - Duration Chart (Last 10 Activity Total Duration)
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="error-chart">
                        Top 10 Job - Error Chart (Last 10 Activity Total Error)
                      </Nav.Link>
                    </Nav.Item>
                  </Nav>
                </Col>
                  ...
                  <Tab.Content>
                    <Tab.Pane eventKey="duration-chart">
                      <div
                        ...
                        <ChartWithLoading
                          ...
                          data={_.orderBy(
                            durationChartData,
                            ["Last 10 Activity Total Duration"],
                            ["desc"]
                          ).filter((val, key) => key <= 9)} //Order by Last 10 Activity Total Duration - top 10 job
                    ...
                    <Tab.Pane eventKey="error-chart">
                      <div
                        ...
                        <h3>
                          <b>Top 10 Job - Error Chart (Last 10 Activity Total Error)</b>
                        </h3>
                        <ChartWithLoading
                          isLoading={loading}
                          data={_.orderBy(errorChartData, ["error"], ["desc"]).filter(
                            (val, key) => key <= 9
                          )} //Order by error - top 10 job
                          keys={["error"]}
                          indexBy="job"
                          margin={{ top: 25, right: 100, bottom: 50, left: 50 }}
                          padding={0.25}
